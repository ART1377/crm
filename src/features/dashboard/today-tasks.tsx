...
export function TodayTasks() {
  ...
  return (
    <Card className="min-h-fit flex-1 overflow-hidden border-border/60 lg:flex-none">
  ...
  className="group relative flex items-center gap-3 rounded-xl p-3 transition-all hover:bg-muted/50"
>
  {/* Status indicator line */}
  <div
    className={`absolute right-0 top-1/2 h-8 w-1 -translate-y-1/2 rounded-full ${
  ...
  <div className="flex items-center gap-2">
    ...
    <ArrowLeft className="h-3.5 w-3.5 text-muted-foreground opacity-0 transition-all group-hover:opacity-100 group-hover:translate-x-1" />
  </div>
</Link>
            ))}
          </div>
